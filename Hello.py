...
st.markdown(
    ...
    6. {switch_page(title="**Audio Processing Made Easy**", page="/Audio_processing")}: Unleash the full potential of your audio recordings with our sophisticated 
    ...
    7. {switch_page(title="**Real-Time Preview**", page="/Real-time_preview")}: Experience the changes in real-time with our instant preview feature. Fine-tune your 
